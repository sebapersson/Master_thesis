...
#run_rd_sim(param, t_opt, model="Schankenberg", geom="Rectangles", hole_list=hl, times_run=10)
#run_rd_sim(param, t_opt, model="Schankenberg", geom="Circles", hole_list=hl, times_run=10)

# Gierer
param = param_gierer(b = 2.0, a = 0.5, gamma = 20, d = 50)
t_opt = t_opt_class(1.5, 2000)
#run_rd_sim(param, t_opt, model="Gierer", geom="Rectangles", hole_list=hl, times_run=10)
#run_rd_sim(param, t_opt, model="Gierer", geom="Circles", hole_list=hl, times_run=10)
...
param = param_schankenberg(gamma=10, d=100)
t_opt = t_opt_class(7.5, 2000)
#run_rd_sim(param, t_opt, model="Schankenberg", geom="Rectangles", hole_list=hl, ic_list=ic_list, times_run=10)
#run_rd_sim(param, t_opt, model="Schankenberg", geom="Circles", hole_list=hl, ic_list=ic_list, times_run=10)

# Gierer
param = param_gierer(b = 2.0, a = 0.5, gamma = 20, d = 50)
t_opt = t_opt_class(1.5, 2000)
#run_rd_sim(param, t_opt, model="Gierer", geom="Rectangles", hole_list=hl, ic_list=ic_list, times_run=10)
#run_rd_sim(param, t_opt, model="Gierer", geom="Circles", hole_list=hl, ic_list=ic_list, times_run=10)
...
#run_rd_sim(param1, t_opt, model="Schankenberg", geom="Rectangles", hole_list=hl, diff_par_list=diff_par, times_run=10)
#run_rd_sim(param2, t_opt, model="Schankenberg", geom="Rectangles", hole_list=hl, diff_par_list=diff_par, times_run=10)
#run_rd_sim(param1, t_opt, model="Schankenberg", geom="Circles", hole_list=hl, diff_par_list=diff_par, times_run=10)
#run_rd_sim(param2, t_opt, model="Schankenberg", geom="Circles", hole_list=hl, diff_par_list=diff_par, times_run=10)
...
diff_par = [diff_param_class([2], param_gierer(a=0.6, b=2.0, d=50, gamma=20)),
            diff_param_class([15], param_gierer(a=0.6, b=2.0, d=50, gamma=20))]
#run_rd_sim(param, t_opt, model="Gierer", geom="Rectangles", hole_list=hl, ic_list=ic_list, diff_par_list=diff_par, times_run=10)
#run_rd_sim(param, t_opt, model="Gierer", geom="Circles", hole_list=hl, ic_list=ic_list, diff_par_list=diff_par, times_run=10)
